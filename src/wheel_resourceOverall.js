...
let pro = {
    ...
    showAllRes(){
        ...
        // 商品
        let c_lowest =[RESOURCE_SILICON,RESOURCE_METAL,RESOURCE_MIST,RESOURCE_BIOMASS]
        ...
        let colorMap = {
            ...
            [RESOURCE_SILICON]:"rgb(76, 167, 229)",
            [RESOURCE_METAL]:"rgb(247, 212, 146)",
            [RESOURCE_MIST]:"rgb(218, 107, 245)",
            [RESOURCE_BIOMASS]:"rgb(108, 240, 169)"
        }
        let id = 0
